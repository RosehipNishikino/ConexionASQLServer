    ...
    public partial class SampleDataBaseDataSet : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.relationFK_Orders_Customers = new global::System.Data.DataRelation("FK_Orders_Customers", new global::System.Data.DataColumn[] {
                        this.tableTable.CustomerIDColumn}, new global::System.Data.DataColumn[] {
        ...
        public partial class OrdersDataTable : global::System.Data.TypedTableBase<OrdersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public OrdersRow AddOrdersRow(int OrderID, TableRow parentTableRowByFK_Orders_Customers, System.DateTime OrderDate, int OrderQuantity) {
                ...
                object[] columnValuesArray = new object[] {
                        ...
                        OrderDate,
                        OrderQuantity};
                if ((parentTableRowByFK_Orders_Customers != null)) {
                    columnValuesArray[1] = parentTableRowByFK_Orders_Customers[0];
                }
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public TableRow AddTableRow(string CustomerID, string CompanyName, string ContactName, string Phone) {
        ...
        public partial class OrdersRow : global::System.Data.DataRow {
            ...
            public TableRow TableRow {
                get {
                    return ((TableRow)(this.GetParentRow(this.Table.ParentRelations["FK_Orders_Customers"])));
                }
                set {
            ...
            public string ContactName {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("El valor de la columna \'ContactName\' de la tabla \'Table\' es DBNull.", e);
                    }
                }
                set {
            ...
            public string Phone {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("El valor de la columna \'Phone\' de la tabla \'Table\' es DBNull.", e);
                    }
                }
                set {
...
namespace DATOS.SampleDataBaseDataSetTableAdapters {
...
SELECT OrderID, CustomerID, OrderDate, OrderQuantity FROM Orders WHERE (OrderID = @OrderID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::DATOS.Properties.Settings.Default.SampleDataBaseConnectionString;
        }
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Table] WHERE (([CustomerID] = @Original_CustomerID) AND ([CompanyName] = @Original_CompanyName) AND ((@IsNull_ContactName = 1 AND [ContactName] IS NULL) OR ([ContactName] = @Original_ContactName)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_CustomerID", global::System.Data.SqlDbType.NChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "CustomerID", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
